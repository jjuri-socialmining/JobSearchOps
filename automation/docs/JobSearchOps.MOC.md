...
moc_scope: "repo_diagnostic_package"
---
...
- Este MOC es la entrada principal del diagnostico generado para el repo.
- Si el diagnostico cambia, vuelve a ejecutar `bash _automation/dashboard/update-control-center.sh`.
