...
| --------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------- | --------------- | ----------- | -------------------------------------------------------- | ---------- | ---------------------------------------------------------------------------- | ---------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `npm run jobops:full` (raíz)                        | `npm run jobops:full` desde `JobOps-OS/` o `JobSearchOps/`                    | `management multi-source` | `30`            | `10`        | [latest](../../tmp/jobops-pipeline/latest-jobs.md)       | `si`       | ver `config/keywords.yaml` — todos los patrones ya unificados                | `config/keywords.yaml` | `manager` | Pipeline principal. Escribe snapshot en `runs/{run_id}-multi-source-full/`. bc-gov: 6, civicjobs: 42, adzuna-bc: SKIP (sin API keys)        | activo ✅                                   |
| `npm run jobops:test:level1`                        | desde raíz o `JobSearchOps/`                                                  | `management bc-gov only`  | `30`            | `10`        | [latest-level1](../../tmp/jobops-pipeline/latest-level1-jobs.md) | `si` | ver `config/keywords.yaml`                                                 | `config/keywords.yaml` | `manager` | Solo bc-gov. Útil para testear cambios de filtro rápido sin consumir todas las fuentes                                                      | activo ✅                                   |
| `npm run jobops:all-sites`                          | desde raíz o `JobSearchOps/`                                                  | `management multi-source` | `30`            | `10`        | [latest-all-sites](../../tmp/jobops-pipeline/latest-all-sites-jobs.md) | `si` | ver `config/keywords.yaml`                                             | `config/keywords.yaml` | `manager` | Wrapper shell multi-source. Alternativa a `jobops:full`                                                                                    | activo ✅                                   |
| `scripts/jobsearchops/reenviar_ultimo_batch.sh`     | [Reenviar último](../../scripts/jobsearchops/reenviar_ultimo_batch.command)   | `reenvio`                 | `—`             | `—`         | `—`                                                      | `—`        | `—`                                                                          | —                      | —         | Solo reenvía payload existente a n8n. No vuelve a capturar.                                                                                | manual                                     |
| `scripts/jobops-test-level1.sh` ⚠️ legacy           | [Nivel 1 Node](../../scripts/jobops-test-level1.command)                      | `management`              | `30`            | `10`        | —                                                        | `si`       | `journalism` (incompleto — usar `npm run jobops:test:level1` en su lugar)    | `config/keywords.yaml` | `manager` | LEGACY. Keywords excluyentes incompletas. Migrado a `npm run jobops:test:level1`. Mantener solo como referencia histórica.                  | legacy ⚠️                                  |
| `scripts/jobsearchops/buscar_trabajo_general_bc.sh` ⚠️ legacy | —                                                                    | `management multi-source` | `30`            | `10`        | —                                                        | `si`       | `journalism, Manager of Criminal Operations, Financial Analyst, Tax Auditor` (incompleto) | — | `AI` | LEGACY. Keywords excluyentes parciales — no incluía F&B, Healthcare, Trades. Todos los patrones migrados a `keywords.yaml`. Usar `jobops:full`. | legacy ⚠️                                 |
