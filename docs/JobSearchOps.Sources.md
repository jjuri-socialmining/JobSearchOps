---
type: "source_registry_dashboard"
...
| Source | Type | Priority | Method | Status | Frequency | Next Action |
|---|---|---|---|---|---|---|
| JobSearchOps Source Registry | - | - | - | 🔴 NOT STARTED | - | Define the first source registry |
